...
#
soup2 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/kereta-api/kereta-api-makassar-parepare/').read()
...
soup3 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/kereta-api/kereta-api-kalimantan-timur/').read()
...
soup4 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/kereta-api/penyelenggaraan-perkeretaapian-umum-wilayah-provinsi-dki-jakarta/').read()
...
df.to_csv("ProyekKeretaApi.csv", sep=',',index=False)
