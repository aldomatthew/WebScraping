...
#1
#
soup1 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/minyak-gas/kilang-minyak-bontang/').read()
#
...
#
soup2 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/minyak-gas/kilang-minyak-tuban/').read()
...
soup3 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/minyak-gas/revitalisasi-5-kilang-minyak-eksisting-rdmp/').read()
...
#
soup4 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/ketenaga-listrikan/pengembangan-lapangan-abadi-wilayah-kerja-masela/').read()
...
#
soup5 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/ketenaga-listrikan/lapangan-unitisasi-gas-jambaran-tiung-biru/').read()
...
#
soup6 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/ketenaga-listrikan/pengembangan-lapangan-gendalo-maha-gandang-gahem-dan-bangka-indonesia-deepwater-development-projectidd/').read()
...
soup7 = urllib.request.urlopen('https://kppip.go.id/proyek-prioritas/ketenaga-listrikan/proyek-tangguh-lng-train-3/').read()
p_soup7 = bs.BeautifulSoup(soup7,'lxml')
title_7 = p_soup7.findAll('div',class_='container')[3]
get_title_7 = title_7.h1.text
print(get_title_7)
tabel_7 = p_soup7.findAll('table')[0]
get_tbody_7 = tabel_7.findAll('tbody')[0]
get_tr_7 = get_tbody_7.findAll('tr')[1]
get_invest7 = get_tr_7.findAll('td')[2].get_text()
print(get_invest7)

mylist.append(get_title_7)
mylist2.append(get_invest7)
#

df = pandas.DataFrame(data={"nama_proyek": mylist, "nilai_investasi": mylist2})
df.to_csv("ProyekMinyakdanGas", sep=',',index=False)
